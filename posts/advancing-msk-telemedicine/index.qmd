...
description: My capstone paper combined my interests in chiropractic, health informatics, and broadcasting live video. Here is the full-text of my paper as submitted with minor changes for the web.
date: 2024-07-28
author:
  - name: Nathan Cashion
    id: nc
...
copyright:
  ...
  year: 2024
image: 3BroadcastSetup.png
bibliography: ../../references.bib
---

::: column-page
![*What can telemedicine providers learn from live streamers?*](3BroadcastSetup.png)
:::
...
When new topics or keywords appeared frequently in my initial results, I explored them further by searching the same databases. I also used the artificial intelligence research assistants [Elicit](https://elicit.com) and [ResearchRabbit](https://researchrabbit.ai) to suggest other articles or related topics.
...
![*Looking directly into the camera can simulate eye contact and help build professional intimacy.*](slide-10.png)
...
![*By incorporating visual stimuli, telemedicine providers can increase patient engagement.*](TelehealthOverlayConcept.002.png)
...
![*YouTubers like Cleo Abram focus on content quality over quantity, resulting in high viewer engagement.*](3CleoAbram.png)
...
![*Peloton instructors are trained to speak directly to participants while taking advantage of multiple camera angles.*](PelotonWideRightShot.png)
